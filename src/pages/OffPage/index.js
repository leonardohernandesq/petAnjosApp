    ...
    return (
      <ScrollView showsVerticalScrollIndicator={false} style={styles.scrollview}>
        ...
        <OffHeader />
          ...
          <TouchableOpacity style={styles.DivAuth} onPress={() => alert('Essa Página é somente para membros do Grupo Anjos')}>
          ...
          <View style={styles.ContainerButtons}>
            ...
            <View style={styles.containerScrollAuth}>
              <TouchableOpacity style={styles.botaoService} onPress={() => alert('Essa Página é somente para membros do Grupo Anjos')}>
                <Image
